...
export const LoadDetailModal: React.FC<LoadDetailModalProps> = ({ load, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative bg-white w-full h-full sm:h-auto sm:max-w-2xl sm:rounded-xl shadow-2xl flex flex-col max-h-[95vh]">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-gray-100 bg-gray-50 sm:rounded-b-xl flex justify-end">
          <button
            onClick={onClose}
            className="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 shadow-sm w-full sm:w-auto"
          >
            Done
          </button>
        </div>
